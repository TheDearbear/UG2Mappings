...
public class TexturePackChunks : ITexturePackReader
{
    ...
    public TexturePack Deserialize(BinarySpan span, long dataBasePosition)
    {
        ...
        var header = new TexturePackHeaderChunks();
        var data = new TextureVRAMDataChunks();
        ...
        while (span.Pointer < span.Length)
        {
            ...
            {
                data.Deserialize(chunkBuffer, pack, span.Pointer - chunkBuffer.Length);
            }
        }
